                                    ...
                                    <tbody>
                                        @foreach ($mobil as $b)
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <p class="text-xs font-weight-bold mb-0">{{ $b->model_mobil }}
                                                    </p>
                                                </td>
