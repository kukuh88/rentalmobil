...
<head>
    ...
    <title>Register | RentalMobilKu</title>
                        ...
                        <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                            ...
                            <div class="d-flex justify-content-center py-4">
                                <a href="/login" class="logo d-flex align-items-center w-auto">
                                    ...
                                    <span class="d-none d-lg-block">RentalMobilKu</span>
                                </a>
                            </div><!-- End Logo -->
                                    ...
                                    <form class="row g-3 needs-validation" method="POST"
                                        ...
                                        <div class="col-12">
                                            ...
                                            <input type="text" name="no_hp" class="form-control" id="no_hp"
                                                required>
                                            <div class="invalid-feedback">Nomor Telpon</div>
                                        </div>
                                        ...
                                        <div class="col-12">
                                            ...
                                            <input type="email" name="email" class="form-control" id="yourEmail"
                                                required>
                                            <div class="invalid-feedback">Masukan Alamat Email</div>
                                        </div>
                                        ...
                                        <div class="col-12">
                                            <label for="password_confirmation" class="form-label">Confrim
                                                Password</label>
                                            <input type="password" name="password_confirmation" class="form-control"
                                                id="password_confirmation" required>
                                            <div class="invalid-feedback">Please enter your Confrim password!</div>
                                        </div>
                                        ...
                                        <div class="col-12">
                                            <div class="form-check">
                                                ...
                                                <label class="form-check-label" for="acceptTerms">I agree and accept
                                                    the
                                                    <a href="/bug">terms and conditions</a></label>
                            ...
                            <div class="credits">
                                Designed by <a href="https://www.instagram.com/k.kukuh/?r=nametag%2F">SDM & IT</a>
                            </div>
